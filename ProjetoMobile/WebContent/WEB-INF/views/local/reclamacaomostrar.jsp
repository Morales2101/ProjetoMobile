...
<body style="background: transparent;">
	...
	<div id="main" class="container">
		...
		<div class="row">
			...
			<div class="col-md-4">
				<img alt="?" src="img/${reclamacao.fotoAnexa}"
